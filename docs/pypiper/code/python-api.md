...
```python
def report_object(self, key, filename, anchor_text=None, anchor_image=None, annotation=None, nolog=False, result_formatter=None)
```
...
*Version Information: `pypiper` v0.13.3a1, generated by `lucidoc` v0.4.4*